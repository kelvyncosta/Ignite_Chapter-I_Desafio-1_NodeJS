...
Para que esse teste passe, você deve permitir que um usuário seja criado e retorne um JSON com o usuário criado. Você pode ver o formato de um usuário [aqui](#userDefinition). 
...
![Exemplo](https://i.imgur.com/lpB0ulv.jpeg)
